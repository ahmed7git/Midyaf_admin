...
/// 📂 شيت تعديل بيانات القسم (Edit Category Bottom Sheet)
class EditCategorySheet extends StatelessWidget {
  final CategoriesModel category;

  const EditCategorySheet({super.key, required this.category});

  static void show(BuildContext context, CategoriesModel category) {
    Get.bottomSheet(
  ...
  Widget build(BuildContext context) {
    if (Get.isRegistered<EditcateControllerImp>()) {
      Get.delete<EditcateControllerImp>(force: true);
    }
    final controller = Get.put(EditcateControllerImp());
    ...
    return Container(
      ...
      child: GetBuilder<EditcateControllerImp>(
                ...
                children: [
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: controller.file != null
                            ? (controller.file!.path.endsWith('.svg')
                  ...
                  Center(
                    child: TextButton.icon(
                      ...
                      label: Text(
                        controller.file != null ? "تم تحديد صورة جديدة" : "تغيير صورة القسم (SVG)",
                        style: TextStyle(
                          fontFamily: 'IBMPlexSansArabic',
                          fontSize: 11.5.sp,
                          fontWeight: FontWeight.bold,
