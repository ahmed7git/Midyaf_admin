...
/// 📦 شيت إضافة منتج جديد بتصميم مودرن (Add Item Bottom Sheet)
class AddItemSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (Get.isRegistered<AddItemControllerImp>()) {
      Get.delete<AddItemControllerImp>(force: true);
    }
                ...
                children: [
                  ...
                  Center(
                    child: TextButton.icon(
                      ...
                      label: Text(
                        controller.file != null ? "تغيير الصورة المحددة" : "اختيار صورة المنتج",
                        style: TextStyle(
                          fontFamily: 'IBMPlexSansArabic',
                          fontSize: 11.5.sp,
                          fontWeight: FontWeight.bold,
