...
class ShowCategoryBottomSheetEit {
  ShowCategoryBottomSheetEit({required EditItemControllerImp controller});

  final EditItemControllerImp controller = Get.find<EditItemControllerImp>();
