...
import 'package:admin/screen/widgets/items/editsheet.dart';
...
class Edititems extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("تعديل قسم"), centerTitle: true),
          ...
          widget: Form(
            ...
            child: ListView(
              children: [
                ...
                SizedBox(height: 20),
                GestureDetector(
                  onTap: () => ShowCategoryBottomSheetEit(controller: controller).show(context),
                  child: Container(
